...
// Configuration privée au module : main.cpp n'a pas à connaître ces détails.
static const twai_general_config_t g_config = TWAI_GENERAL_CONFIG_DEFAULT(
    (gpio_num_t)PIN_CAN_TX,   // TX (non connecté)
    (gpio_num_t)PIN_CAN_RX,   // RX
    TWAI_MODE_LISTEN_ONLY     // Écoute seule : ni émission, ni ACK, ni trame d'erreur
);
